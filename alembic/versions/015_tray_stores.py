...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("seller_id", sa.Text, nullable=False, unique=True),
    ...
    op.create_index("idx_tray_stores_seller", "tray_stores", ["seller_id"])


def downgrade() -> None:
    op.drop_index("idx_tray_stores_seller", table_name="tray_stores")
    op.drop_table("tray_stores")
