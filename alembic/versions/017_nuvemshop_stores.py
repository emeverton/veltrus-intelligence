...
def upgrade() -> None:
    ...
    op.create_index("idx_nuvem_stores_id", "nuvemshop_stores", ["store_id"])


def downgrade() -> None:
    op.drop_index("idx_nuvem_stores_id", table_name="nuvemshop_stores")
    op.drop_table("nuvemshop_stores")
